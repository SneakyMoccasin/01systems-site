...
export function CascadeEnginePageContent() {
  ...
  return <main className="page-shell cascade-product-page">
    ...
    <Section title={copy.margin}><Bullets items={copy.marginItems}/><figure className="cascade-product-figure"><LocalizedMediaLightbox key={media.structuralMargin.src} image={media.structuralMargin} alt={copy.margin} helpText={copy.enlarge} closeLabel={copy.closeImage} dialogLabel={copy.imageDialog}/><figcaption className="cascade-product-caption">{copy.marginCaption}</figcaption></figure></Section>
    ...
    <Section title={copy.consequences}><Bullets items={copy.consequenceItems}/><figure className="cascade-product-figure"><LocalizedMediaLightbox key={media.executiveProofNarrative.src} image={media.executiveProofNarrative} alt={copy.consequencesAlt} helpText={copy.enlarge} closeLabel={copy.closeImage} dialogLabel={copy.imageDialog}/></figure></Section>
