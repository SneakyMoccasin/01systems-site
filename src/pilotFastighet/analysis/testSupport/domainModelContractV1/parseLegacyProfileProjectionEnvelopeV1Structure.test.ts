...
test("locks all envelope literal and discriminant families", () => {
  const cases: readonly [((x: any) => void), string, string][] = [
    ...
    [(x) => { x.compatibility.propagation.edgeEvaluationOrder = "sorted"; }, "invalid-literal", "/compatibility/propagation/edgeEvaluationOrder"], [(x) => { x.compatibility.propagation.compatibilityOnlyEdges[0].hasScore = true; }, "invalid-literal", "/compatibility/propagation/compatibilityOnlyEdges/0/hasScore"],
    [(x) => { x.compatibility.propagation.compatibilityOnlyEdges[0].implicitSourceNodeId = "other"; }, "invalid-literal", "/compatibility/propagation/compatibilityOnlyEdges/0/implicitSourceNodeId"], [(x) => { x.compatibility.propagation.compatibilityOnlyEdges[0].adapterLocalImplicitNodeId = "other"; }, "invalid-literal", "/compatibility/propagation/compatibilityOnlyEdges/0/adapterLocalImplicitNodeId"],
    [(x) => { x.compatibility.propagation.compatibilityOnlyEdges[0].missingReadDefaultLevelId = "other"; }, "invalid-literal", "/compatibility/propagation/compatibilityOnlyEdges/0/missingReadDefaultLevelId"], [(x) => { x.compatibility.propagation.compatibilityOnlyEdges[0].materializeOnRaise = false; }, "invalid-literal", "/compatibility/propagation/compatibilityOnlyEdges/0/materializeOnRaise"],
    [(x) => { x.compatibility.propagation.compatibilityOnlyEdges[0].hasImpacts = true; }, "invalid-literal", "/compatibility/propagation/compatibilityOnlyEdges/0/hasImpacts"], [(x) => { x.compatibility.excludedSourceValues[0].kind = "other"; }, "invalid-literal", "/compatibility/excludedSourceValues/0/kind"],
