...
test("diagnostics equal explicit profile-local locked data over two independent pipelines",()=>{
  ...
  const expected={"legacy-real-estate-v1":[...common(fallback),{code:"legacy-ignored-unknown-driver-delta",path:"/compatibility/ignoredUnknownDriverDeltas/0",message:"legacy-ignored-unknown-driver-delta:legacy-real-estate-v1:stagger_project_starts:implementationPacingRisk:-1"},{code:"legacy-ignored-unknown-driver-delta",path:"/compatibility/ignoredUnknownDriverDeltas/1",message:"legacy-ignored-unknown-driver-delta:legacy-real-estate-v1:increase_liquidity_buffer:liquidityPressure:-1"},order,execution,...edges,{code:"legacy-sustain-threshold-override-declared",path:"/compatibility/sustainThresholdOverride",message:"legacy-sustain-threshold-override-declared:not-covered-by-m0b-engine-goldens"}],"legacy-municipal-v1":[...common([{reason:"profile-constraint-disabled",path:"constraints.RefinancingConstraint"},...fallback]),{code:"legacy-compatibility-only-action",path:"/compatibility/compatibilityOnlyActions/0",message:"legacy-compatibility-only-action:congestion_pricing:omitted-from-native-actions"},order,execution],"legacy-consulting-v1":[...common(fallback),{code:"legacy-compatibility-only-action",path:"/compatibility/compatibilityOnlyActions/0",message:"legacy-compatibility-only-action:congestion_pricing:omitted-from-native-actions"},order,execution,...edges,{code:"legacy-sustain-threshold-override-declared",path:"/compatibility/sustainThresholdOverride",message:"legacy-sustain-threshold-override-declared:not-covered-by-m0b-engine-goldens"}]};
